 ...
 * @param {Array<{index:number, title: String}>} - [必填] step内容数组，index为step步骤数字，title为下方文字说明，传入的数组须有序， title为可选
 */
            ...
            return (React.createElement("div", { className: className.stepField, key: index },
                React.createElement("div", { className: className.state, style: { width: index < this.props.steps.length - 1 ? `${this.realWidth / 4}px` : 'width: 32px' } },
                    React.createElement("div", { className: this.changeCircleStyle(index) },
                        React.createElement("span", { style: { display: index >= this.props.current_index ? "inline-block" : "none" } }, value.index),
                        React.createElement("img", { className: className.okImg, src: require("@/assets/image/StepProgressBar/ok.svg"), width: "24px", height: "24px", style: { display: index >= this.props.current_index ? "none" : "inline" } })),
